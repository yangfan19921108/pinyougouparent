...
public class TypeTemplateServiceImpl implements TypeTemplateService {
    ...
    public List<Map> findSpecList(Long id) {
        ...
        //得到spec集合[{"id":27,"text":"网络"},{"id":32,"text":"机身内存"}]
    ...
    private void saveToReids(){
        ...
        for (TbTypeTemplate tbTypeTemplate : tbTypeTemplates) {
            List<Map> brandlList = JSON.parseArray(tbTypeTemplate.getBrandIds(), Map.class);
            List<Map> specList = JSON.parseArray(tbTypeTemplate.getSpecIds(), Map.class);
            //c存入缓存
            redisTemplate.boundHashOps("brandList").put(tbTypeTemplate.getId(),brandlList);
